...
The wrappers under [`jigs/`](jigs/) refuse to run unless `--execute` is supplied. Review them first. They can consume Codex subscription quota, provider API credits, Docker resources, and substantial wall time.
